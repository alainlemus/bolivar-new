                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $phone) }}"
                                        class="text-lg text-gray-800 hover:text-amber-600 font-medium">{{ $phone }}</a>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsapp) }}"
                                        target="_blank"
                                        class="text-lg text-gray-800 hover:text-green-600 font-medium">{{ $whatsapp }}</a>
                                </div>
                            </div>
                        @endif
                        ...
                        @if ($email)
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $email }}"
                                        class="text-lg text-gray-800 hover:text-amber-600 font-medium">{{ $email }}</a>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                        ...
                        <form wire:submit="submit" class="space-y-4">
                            ...
                            <div>
                                ...
                                @enderror
                                @if(!$errors->has('message') && strlen($message) > 0 && strlen($message) < 10)
                                    <span class="text-red-500 text-sm flex items-center mt-1">
                                        <svg class="w-4 h-4 mr-1 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
