        ...
        <div class="max-w-3xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-8">
                <div class="flex items-center justify-center">
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $phone1) }}" class="flex items-center text-xl hover:text-amber-400 transition">
                ...
                <div class="flex items-center justify-center">
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $phone2) }}" class="flex items-center text-xl hover:text-amber-400 transition">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                        {{ $phone2 }}
            ...
            <div class="bg-gray-700/50 p-6 rounded-lg">
                ...
                <p class="text-gray-300 whitespace-pre-line">{{ $address }}</p>
            </div>
        </div>
    </div>
</div>